...
namespace Yamac.Controls
{
    public partial class WebBrowser2 : UserControl
    {
        ...
        private Regex invalidIframeTagRegex = new Regex(@"<div class=""maist"">.*?</div>", RegexOptions.IgnoreCase | RegexOptions.Singleline);
                ...
                (
                    res =>
                    {
                        ...
                        */
                        ...
                        mainHtml = invalidIframeTagRegex.Replace(mainHtml, "");
